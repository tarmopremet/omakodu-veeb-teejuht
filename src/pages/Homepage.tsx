        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          ...
          <div className="group">
            <Link to="/tekstiilipesuri-rent" className="block">
              ...
              <h3 className="text-center text-sm font-medium text-gray-800 mb-2">
                Tekstiilipesur
              </h3>
          ...
          <div className="group">
            <Link to="/aurupesuri-rent" className="block">
              ...
              <div className="flex justify-center">
                <Button
                  className="bg-primary hover:bg-primary-hover text-primary-foreground text-xs px-3 py-1 rounded-full"
                >
                  Broneerima
                </Button>
              </div>
          ...
          <div className="group">
            <Link to="/aknapesuroboti-rent" className="block">
              <div className="aspect-square rounded-lg overflow-hidden mb-3 bg-gray-100">
                <img 
                  src="/src/assets/window-robot-new.jpg"
                  alt="Aknapesurobot"
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
                />
              </div>
          ...
          {/* Aknapesur */}
          <div className="group">
            <Link to="/aknapesuri-rent" className="block">
              <div className="aspect-square rounded-lg overflow-hidden mb-3 bg-gray-100">
                <img 
                  src="/src/assets/steam-cleaner.jpg"
                  alt="Aknapesur"
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
                />
              </div>
          ...
          <div className="group">
            <Link to="/aurupesuri-rent" className="block">
              <div className="aspect-square rounded-lg overflow-hidden mb-3 bg-gray-100">
                <img 
                  src="/src/assets/steam-cleaner-karcher.jpg"
                  alt="Aurupesur Pro"
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
                />
              </div>
