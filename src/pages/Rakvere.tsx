...
const Rakvere = () => {
  ...
  const rentalProducts = [
    {
      id: "1",
      name: "TEKSTIILIPESUR 1 (Tsentrumis)",
      price: "4.5€ / Tund",
      location: "Rakvere, Laada 14, Tsentrum",
    ...
    },
    {
      ...
      price: "3.5€ / Tund",
      location: "Rakvere, Haljala mnt 4, Maxima",
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-6">
            Tekstiilipesuri nutirent Rakveres
          </h1>
